...
SELECT
    ...
    dbt_updated_at FROM {{ ref('fct_pdh_gfs_surface') }}
UNION ALL
SELECT
    surrogate_merge_key,
    weather_model,
    ...
    dbt_updated_at FROM {{ ref('fct_pdh_aifs_surface') }}
UNION ALL
SELECT
    surrogate_merge_key,
    weather_model,
    ...
    total_precipitation_m,
    total_precipitation_mm,
    dbt_updated_at FROM {{ ref('fct_pdh_ifs_surface') }}